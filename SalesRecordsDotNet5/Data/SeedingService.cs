...
using System;
using SalesRecordsDotNet5.Models.Enums;
...
namespace SalesRecordsDotNet5.Data
{
    ...
    {
        private SalesRecordsDotNet5Context _context;

        public SeedingService(SalesRecordsDotNet5Context context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d5 = new Department { Id = 5, Name = "Others" }; //Alternative
            #endregion
            ...
            Seller s3 = new Seller(3, "Alex Grev", "alex@gmail.com", new DateTime(1988, 1, 15), 2200.00, d3);
            Seller s4 = new Seller(4, "Martha Red", "martra@gmail.com", new DateTime(1993, 11, 30), 3000.00, d1);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 1, 9), 1750.00, d5);
            Seller s6 = new Seller(6, "Alex Pink", "pink@gmail.com", new DateTime(1997, 3, 4), 2500.00, d4);
            Seller s7 = new Seller(7, "João Paulo", "joao@gmail.com", new DateTime(1998, 6, 5), 5000.00, d1);
            #endregion
            ...
            _context.Seller.AddRange(s1, s2, s4, s4, s5, s6, s7);
